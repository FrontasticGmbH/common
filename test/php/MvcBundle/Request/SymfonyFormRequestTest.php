...
namespace Frontastic\Common\MvcBundle\Request;
...
class SymfonyFormRequestTest extends TestCase
{
    ...
    public function it_allows_handle_only_once() : void
    {
        ...
        $this->expectException('Frontastic\Common\Mvc\Exception\FormAlreadyHandledException');
        $formRequest->handle('form_type');
    }
    ...
    public function it_requires_handle_before_create_view() : void
    {
        ...
        $this->expectException('Frontastic\Common\Mvc\Exception\NoFormHandledException');
