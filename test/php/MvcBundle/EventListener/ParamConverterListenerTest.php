...
use Frontastic\Common\MvcBundle\ParamConverter\SymfonyServiceProvider;
...
class ParamConverterListenerTest extends TestCase
{
    ...
    {
        $this->assertRequestHasContext('\Frontastic\Common\MvcBundle\EventListener\iAmAController');
    }
